      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                          ...
                          CircleAvatar(
                            ...
                            backgroundImage: myPhoto != null
                                ? CachedNetworkImageProvider(
                                    myPhoto!) // Use CachedNetworkImageProvider for caching
                                : const AssetImage("assets/images/default.jpeg")
                                    as ImageProvider,
                            // Placeholder image if myPhoto is null
                            child: myPhoto !=
                                    null // If myPhoto is not null, show loading indicator
                                ? ClipOval(
                                    child: SizedBox(
                                      width: 80, // Size to match CircleAvatar
                                      height: 80,
            ...
            buildSettingOptions(
                titleText: 'Account',
                subtitleText: "Security notifications, change number",
                iconData: Icons.key),
            buildSettingOptions(
                titleText: 'Privacy',
                subtitleText: "Block contacts, disappearing messages",
                iconData: Icons.lock_outline),
            buildSettingOptions(
                titleText: 'Avatar',
                subtitleText: "Create, edit, profile photo",
                iconData: Icons.face_unlock_outlined),
            buildSettingOptions(
                titleText: 'Favourites',
                subtitleText: "Add reorder, remove",
                iconData: Icons.favorite_border_sharp),
            buildSettingOptions(
                titleText: 'Chats',
                subtitleText: "Theme, wallpapers, chat history",
            ...
            buildSettingOptions(
                ...
                subtitleText: "English (device's language",
                iconData: Icons.language),
            buildSettingOptions(
                titleText: 'Help',
                subtitleText: "Help centre, contact us, privacy policy",
                iconData: Icons.help_outline_sharp),
            buildOtherOptions(
                titleText: "Invite a friend",
                iconData: Icons.people_alt_outlined),
            buildOtherOptions(
                titleText: "App updates",
                iconData: Icons.security_update_outlined),
            const SizedBox(
              height: 30,
            ),
            const Padding(
            ...
            buildSocialTile(
                titleText: "Open Instagram",
                iconData: FontAwesomeIcons.instagram),
            buildSocialTile(
                titleText: "Open Facebook",
                iconData: FontAwesomeIcons.facebook),
            buildSocialTile(
                titleText: "Open Threads", iconData: FontAwesomeIcons.threads),
          ],
        ),
      ),
    );
